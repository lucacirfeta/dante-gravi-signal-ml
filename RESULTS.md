...
**Veto Results:**
- **Table 3a (Confirmed Local Glitches):** 110 candidates. The partner was online, but the sub-threshold morphological match yielded $S < 0.9750$ (calibrated via Weibull-tail EVT).
