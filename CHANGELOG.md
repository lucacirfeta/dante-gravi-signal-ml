...
- Published package and citation metadata for the `v3.8.0` archival release at
  DOI `10.5281/zenodo.22681395`; the 3.7.0 version DOI remains historical and
  is not assigned to 3.8.0.
