...
from src.pipeline_v1_legacy.reporter import save_cluster_report, print_summary
from src.pipeline_v1_legacy.similarity_checker import run_morphological_crosscheck, print_morphological_summary
...
from src.core.utils import load_config, setup_logger, session_path
from src.core.logging_utils import PhaseTracker, get_phase_logger
    ...
    try:
        ...
        if similarity_report_file.exists():
            ...
            if det_report["steps"].get("morphcheck", {}).get("status") in ("OK", "SKIPPED"):
                ...
                from src.pipeline_v1_legacy.similarity_analysis import analyze_similarity
