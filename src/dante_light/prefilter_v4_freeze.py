...
def build_protocol(
    ...
    body={
        ...
        "scientific_boundary":{"primary_development_run":"O4A","external_known_glitch_run":"O3B",
            ...
            "does_not_establish":[
                "sensitivity_to_physical_NSBH_waveforms_with_tidal_effects",
                "sensitivity_to_precessing_or_higher_mode_CBC_waveforms",
                "astrophysical_sensitivity_or_operational_routing_readiness",
            ],
            "nsbh_injection_limitation":"IMRPhenomD treats the NSBH benchmark as point-particle aligned-spin inspiral-merger-ringdown and omits neutron-star tidal effects"},
        ...
        "injection_waveform_contract":{"purpose":"legacy_comparability_isolating_phase_representation",
            "approximant":"IMRPhenomD","sample_rate_hz":4096,"window_duration_s":32.0,
            "placement":"geocentric_merger_at_window_midpoint_plus_detector_delay",
            "snr_role":"diagnostic_only_never_selection_or_gate",
            "systems":{
            ...
            "generator_source":_ref(root,"src/pipeline_v2_production/astrophysical_injection.py")},
        ...
        "feature_extraction":{"feature_version":"prefilter-v4-phase-primary","features":list(PHASE_FEATURES),
            "sample_rate_hz":4096,"analysis_duration_s":32.0,"analysis_band_hz":[20.0,1024.0],"whitening_context_pad_s":4.0,
        ...
        "development":{"cross_validation_folds":5,"cross_validation_method":"shuffled_group_k_fold_detector_4096s_block",
            ...
            "minimum_retention_by_role":{"robust_candidate":0.9,"known_glitch":0.9,"injection":0.9},
            "minimum_wilson_lower_by_role":{"robust_candidate":0.8,"known_glitch":0.8,"injection":0.8},
            "minimum_group_n_by_role":{"robust_candidate":25,"known_glitch":25,"injection":35},
            "feature_subset_selection_allowed":False,"failed_primary_status":"V4_NOT_READY_NO_SAME_COHORT_RETUNING"},
        "audit":{"fraction":0.05,"seed":seeds["audit"]},
        ...
        "uncertainty":{"method":"detector_gps_4096s_block_bootstrap","n_resamples":2000,"confidence":0.95,
            "seed":seeds["bootstrap"],"eligible_for_gate":False},
...
def build_freeze(
    ...
    *,
    ...
    seal=build_confirmation_seal(complete,freeze_commit=freeze_commit,code_references={
        ...
        "production_extractor":_ref(root,"src/dante_light/prefilter_v4.py"),
        "preprocessing":_ref(root,"src/dante_light/preprocessing.py"),
        "development_ledger":_ref(root,"src/dante_light/prefilter_v4_development.py"),
        "development_screening":_ref(root,"src/dante_light/prefilter_v4_screening.py"),
        "development_verifier":_ref(root,"scripts/verify_dante_light_prefilter_v4_development.py"),
