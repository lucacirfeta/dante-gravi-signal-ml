...
def _save_json_report(
    ...
    report = {
        ...
        "results": {
            ...
            "silhouette_umap": result.get("silhouette_umap"),
            "silhouette_pca": result.get("silhouette_pca"),
            "davies_bouldin_umap": result.get("davies_bouldin_umap"),
            "davies_bouldin_pca": result.get("davies_bouldin_pca"),
